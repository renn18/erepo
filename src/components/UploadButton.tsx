    ...
    return <Dropzone multiple={false} onDrop={async(acceptedFiles) => {
    ...
    }}>
        {
            ({getRootProps, getInputProps, acceptedFiles})=> (
                <div{...getRootProps()} className="border h-64 m-4 border-dashed broder-gray-300 rounded-lg">
                        ...
                        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-full rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                            <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p className="mb-2 text-sm text-zinc-700">
                                    <span className="font-semibold">Klik untuk upload
                                    </span>{' '}
                                    atau seret dan drop
                                </p>
                                <p className="text-xs text-zinc-500">Batas file sampai 4MB</p>
                            </div>
